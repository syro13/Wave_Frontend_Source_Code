...
public class EditTasksActivity extends AppCompatActivity {
    ...
    private void saveEditedTask() {
        ...
        Task updatedTask = new Task(
                ...
                updatedTime,
                dateParts[0],
                getMonthYearList().get(Integer.parseInt(dateParts[1]) - 1), // ✅ Fixed issue here
                selectedPriority,
                selectedTaskType,
                updatedRemind,
                ...
                updatedDate,
                false,
                Task.RepeatOption.DOES_NOT_REPEAT
        );
        ...
        FirebaseFirestore.getInstance().collection("users").document(userId)
                .collection("School".equals(updatedTask.getCategory()) ? "schooltasks" : "housetasks")
                .document(task.getId())
                .set(updatedTask)
